 ...
 *
 * Adds sticky headers capabilities to your {@link RecyclerView.Adapter}. It must implement {@link StickyHeaderHandler} to
 * indicate which items are headers.
 *
 * @link https://github.com/Doist/RecyclerViewExtensions/blob/master/StickyHeaderHandler
 */
public class StickyLinearLayoutManager<T extends RecyclerView.Adapter & StickyHeaderHandler>
extends LinearLayoutManager {
    ...
    private void setAdapter(RecyclerView.Adapter adapter) {
        ...
        if (adapter instanceof StickyHeaderHandler) {
            mAdapter = (T) adapter;
    ...
    private void createStickyHeader(@NonNull RecyclerView.Recycler recycler, int position) {
        ...
        if (mAdapter instanceof StickyHeaderHandler.ViewSetup) {
            ((StickyHeaderHandler.ViewSetup) mAdapter).setupStickyHeaderView(stickyHeader);
        }
    ...
    private void scrapStickyHeader(@Nullable RecyclerView.Recycler recycler) {
        ...
        if (mAdapter instanceof StickyHeaderHandler.ViewSetup) {
            ((StickyHeaderHandler.ViewSetup) mAdapter).teardownStickyHeaderView(stickyHeader);
        }
